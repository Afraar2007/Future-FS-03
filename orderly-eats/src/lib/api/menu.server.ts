...
const MENU: MenuItem[] = [
  {
    ...
    longDescription:
      "Four hand-folded samosas with a flaky shell and fragrant potato-pea filling, served with mint-coriander chutney.",
    price: 10,
    category: "Starters",
    rating: 4.6,
    prepMinutes: 12,
  ...
  },
  {
    ...
    longDescription:
      "A soft, creamy cheese served with grilled bread, olive oil and sea salt — a delicate, shareable starter.",
    price: 15,
    category: "Starters",
    rating: 4.5,
    prepMinutes: 8,
