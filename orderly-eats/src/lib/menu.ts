import { generateAIImage } from "./aiImages";

export type Category = "All" | "Mains" | "Starters" | "Desserts" | "Drinks";
...
export const CATEGORIES: Category[] = ["All", "Mains", "Starters", "Desserts", "Drinks"];
